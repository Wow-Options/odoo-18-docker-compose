...
``` bash
curl -s https://raw.githubusercontent.com/Wow-Options/odoo-18-docker-compose/master/run.sh | sudo bash -s odoo-one 10018 20018

```
and/or run the following to set up another Odoo instance @ `localhost:11018` (default master password: `mostafa@1234`):

``` bash
curl -s https://raw.githubusercontent.com/Wow-Options/odoo-18-docker-compose/master/run.sh | sudo bash -s odoo-two 11018 21018
```
